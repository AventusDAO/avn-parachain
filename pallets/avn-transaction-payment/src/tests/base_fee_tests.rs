...
fn simulate_fee_from(who: &AccountId, fee: Balance) {
    let credit =
        <pallet_balances::Pallet<mock::TestRuntime> as frame_support::traits::fungible::Balanced<
            <mock::TestRuntime as frame_system::Config>::AccountId,
        >>::withdraw(
            &who,
            fee,
    ...
    mock::DealWithFeesForTest::on_unbalanceds(core::iter::once(credit));
}
